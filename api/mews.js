...
export default async function handler(req, res) {
  ...
  try {
    ...
    const ALLOWED = [
      "configuration/get","enterprises/getAll","services/getAll","services/getAvailability",
      "resources/getAll","resourceCategories/getAll","resourceBlocks/getAll",
      "reservations/getAll/2023-06-06","reservations/price","rates/getAll","rateGroups/getAll",
      "customers/getAll","payments/getAll","sources/getAll","companionships/getAll",
      "products/getAll","orderItems/getAll","bills/getAll","businessSegments/getAll",
      "currencies/getAll","cancellationPolicies/getAll","restrictions/getAll",
      "sourceAssignments/getAll","reservationGroups/getAll","accountingCategories/getAll",
      "exports/getAll","exports/add"
    ];
